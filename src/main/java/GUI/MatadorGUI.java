...
public class MatadorGUI {
    ...
    public static void GUIfelter() {
        ...
        GUI_Street st9 = new GUI_Street("Nørrebro", "160$", "", "160", Color.YELLOW, Color.BLACK);
        field[16] = st9;

        GUI_Chance chance3 = new GUI_Chance("?", "Chance", "", Color.WHITE, Color.BLACK);
        field[17] = chance3;

        GUI_Street st10 = new GUI_Street("Nørrebro", "160$", "", "160", Color.YELLOW, Color.BLACK);
        field[18] = st10;

        GUI_Street st11 = new GUI_Street("Nørrebro", "160$", "", "160", Color.YELLOW, Color.BLACK);
        field[19] = st11;

        GUI_Refuge helle = new GUI_Refuge();
        field[20] = helle;

        GUI_Street st12 = new GUI_Street("Nørrebro", "160$", "", "160", Color.RED, Color.BLACK);
        field[21] = st12;

        GUI_Chance chance4 = new GUI_Chance("?", "Chance", "", Color.WHITE, Color.BLACK);
        field[22] = chance4;

        GUI_Street st13 = new GUI_Street("Nørrebro", "160$", "", "160", Color.RED, Color.BLACK);
        field[23] = st13;

        GUI_Street st14 = new GUI_Street("Nørrebro", "160$", "", "160", Color.RED, Color.BLACK);
        field[24] = st14;

        GUI_Shipping sh3 = new GUI_Shipping("default", "Redderi", "200", "", "200", Color.WHITE, Color.BLACK);
        field[25] = sh3;

        GUI_Street st15 = new GUI_Street("Nørrebro", "160$", "", "160", Color.GRAY, Color.BLACK);
        field[26] = st15;

        GUI_Street st16 = new GUI_Street("Nørrebro", "160$", "", "160", Color.GRAY, Color.BLACK);
        field[27] = st16;

        GUI_Brewery carl = new GUI_Brewery();
        field[28] = carl;

        GUI_Street st17 = new GUI_Street("Nørrebro", "160$", "", "160", Color.GRAY, Color.BLACK);
        field[29] = st17;

        GUI_Jail jail2 = new GUI_Jail();
        field[30] = jail2; jail.setSubText("Gå i fængsel");

        GUI_Street st18 = new GUI_Street("Nørrebro", "160$", "", "160", Color.GREEN, Color.BLACK);
        field[31] = st18;

        GUI_Street st19 = new GUI_Street("Nørrebro", "160$", "", "160", Color.GREEN, Color.BLACK);
        field[32] = st19;

        GUI_Chance chance5 = new GUI_Chance("?", "Chance", "", Color.WHITE, Color.BLACK);
        field[33] = chance5;

        GUI_Street st20 = new GUI_Street("Nørrebro", "160$", "", "160", Color.GREEN, Color.BLACK);
        field[34] = st20;
        ...
        GUI_Street st21 = new GUI_Street("Nørrebro", "160$", "", "160", Color.BLUE, Color.BLACK);
        field[37] = st21;

        GUI_Tax tax2 = new GUI_Tax("Betal skat", "Betal 200", "", Color.WHITE, Color.BLACK);
        field[38] = tax2;

        GUI_Street st22 = new GUI_Street("Nørrebro", "160$", "", "160", Color.BLUE, Color.BLACK);
        field[39] = st22;
